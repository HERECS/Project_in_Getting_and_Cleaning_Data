setwd("D:/ling de/Data Science/Getting and Cleaning Data/UCI HAR Dataset")
...
#included whichever containing angle
...
names(DataSet) <- gsub("Mag","Magnitide",names(DataSet))
